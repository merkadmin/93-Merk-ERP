...
public class MerkDbContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder m)
	{
		...
		m.Entity<TableMetaData>().HasData(
			...
			new TableMetaData { Id = 32, TableNameId = 14, ColumnOrder = 6, Key = "wareHouseType", LabelEN = "Type", LabelAR = "النوع", EntityProperty = "WareHouseType", ForeignKeyProperty = "WareHouseTypeId", FilterType = "select" },
			new TableMetaData { Id = 33, TableNameId = 14, ColumnOrder = 7, Key = "wareHouseCategory", LabelEN = "Category", LabelAR = "الفئة", EntityProperty = "WareHouseCategory", ForeignKeyProperty = "WareHouseCategoryId", FilterType = "select" },
			new TableMetaData { Id = 34, TableNameId = 14, ColumnOrder = 4, Key = "isParent", LabelEN = "Is Parent", LabelAR = "أصل", EntityProperty = "IsParent", FilterType = "boolean", DataType = "boolean", RenderAs = "badge" },
			new TableMetaData { Id = 35, TableNameId = 14, ColumnOrder = 8, Key = "isActive", LabelEN = "Active", LabelAR = "نشط", EntityProperty = "IsActive", FilterType = "boolean", DataType = "boolean", RenderAs = "badge" },
			new TableMetaData { Id = 46, TableNameId = 14, ColumnOrder = 5, Key = "parentWareHouse", LabelEN = "Parent", LabelAR = "الرئيسي", EntityProperty = "ParentWareHouse", ForeignKeyProperty = "ParentWareHouse", FilterType = "select" },
			...
			new TableMetaData { Id = 39, TableNameId = 15, ColumnOrder = 5, Key = "description", LabelEN = "Description", LabelAR = "الوصف", EntityProperty = "Description", IsSortable = false },
			new TableMetaData { Id = 40, TableNameId = 15, ColumnOrder = 6, Key = "isActive", LabelEN = "Active", LabelAR = "نشط", EntityProperty = "IsActive", FilterType = "boolean", DataType = "boolean", RenderAs = "badge" },
			new TableMetaData { Id = 45, TableNameId = 15, ColumnOrder = 4, Key = "wareHouseType", LabelEN = "Type", LabelAR = "النوع", EntityProperty = "WareHouseType", ForeignKeyProperty = "WareHouseTypeId", FilterType = "select" },
