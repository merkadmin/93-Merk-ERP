...
namespace MerkERP.DAL.Migrations
{
    ...
    [Migration("20260716161048_AddPurchaseReceiptTableMetadata")]
    partial class AddPurchaseReceiptTableMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MerkERP.Core.Models.PurchaseReceipt", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MerkERP.Core.Models.PurchaseReceiptItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PurchaseReceiptItem");
                });

            modelBuilder.Entity("MerkERP.Core.Models.PurchaseReceiptTax", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MerkERP.Core.Models.PurchaseReceipt", b =>
                {
                    b.HasOne("MerkERP.Core.Models.Company_cs", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MerkERP.Core.Models.Currency_s", "Currency")
                        .WithMany()
                    ...
                    b.HasOne("MerkERP.Core.Models.Supplier_cs", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("MerkERP.Core.Models.PurchaseReceiptItem", b =>
                {
                    ...
                    b.HasOne("MerkERP.Core.Models.PurchaseReceipt", "PurchaseReceipt")
                        .WithMany("Items")
