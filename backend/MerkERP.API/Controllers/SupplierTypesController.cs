...
public class SupplierTypesController(IRepository<SupplierType_s> repo) : ControllerBase
{
	...
	[HttpPost] public async Task<IActionResult> Create(SupplierType_s e) => Ok(await repo.CreateAsync(e));
	[HttpPut("{id}")]
	public async Task<IActionResult> Update(long id, SupplierType_s e)
	{
