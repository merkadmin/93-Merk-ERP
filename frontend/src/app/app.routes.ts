...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'purchase-receipt',               loadComponent: () => import('./features/purchase-receipts/purchase-receipts.component').then(m => m.PurchaseReceiptsComponent) },
      { path: 'purchase-receipt/operation',     loadComponent: () => import('./features/purchase-receipts/operations/purchase-receipts-operation.component').then(m => m.PurchaseReceiptsOperationComponent) },
      { path: 'purchase-receipt/operation/:id', loadComponent: () => import('./features/purchase-receipts/operations/purchase-receipts-operation.component').then(m => m.PurchaseReceiptsOperationComponent) },
